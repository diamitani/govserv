...
const ROADMAP = [
  ...
  { label: "California", status: "live", note: "34 services indexed" },
  { label: "Texas", status: "live", note: "42 services indexed" },
  { label: "Florida", status: "live", note: "37 services indexed" },
  { label: "New York", status: "live", note: "45 services indexed" },
  { label: "Pennsylvania", status: "live", note: "37 services indexed" },
  { label: "Ohio", status: "live", note: "32 services indexed" },
  { label: "Georgia", status: "live", note: "32 services indexed" },
  { label: "North Carolina", status: "live", note: "28 services indexed" },
  { label: "Michigan", status: "live", note: "44 services indexed" },
  { label: "New Jersey", status: "live", note: "37 services indexed" },
  { label: "Virginia", status: "live", note: "28 services indexed" },
  { label: "Washington", status: "live", note: "32 services indexed" },
  { label: "Arizona", status: "live", note: "26 services indexed" },
  { label: "Tennessee", status: "live", note: "31 services indexed" },
  { label: "Indiana", status: "live", note: "34 services indexed" },
  { label: "Maryland", status: "live", note: "32 services indexed" },
  { label: "Missouri", status: "live", note: "35 services indexed" },
  ...
  { label: "Oklahoma", status: "live", note: "36 services indexed" },
  { label: "Nevada", status: "live", note: "26 services indexed" },
  { label: "Iowa", status: "live", note: "43 services indexed" },
  { label: "Arkansas", status: "live", note: "38 services indexed" },
  { label: "Kansas", status: "live", note: "35 services indexed" },
  { label: "Mississippi", status: "live", note: "31 services indexed" },
  { label: "New Mexico", status: "live", note: "29 services indexed" },
  { label: "Nebraska", status: "live", note: "36 services indexed" },
  { label: "West Virginia", status: "live", note: "33 services indexed" },
  { label: "Hawaii", status: "live", note: "39 services indexed" },
  { label: "New Hampshire", status: "live", note: "29 services indexed" },
  { label: "Montana", status: "live", note: "29 services indexed" },
  { label: "Connecticut", status: "live", note: "35 services indexed" },
  { label: "Utah", status: "live", note: "38 services indexed" },
  { label: "Idaho", status: "live", note: "36 services indexed" },
  { label: "Maine", status: "live", note: "26 services indexed" },
  { label: "Rhode Island", status: "live", note: "43 services indexed" },
  { label: "South Dakota", status: "live", note: "26 services indexed" },
  { label: "North Dakota", status: "live", note: "34 services indexed" },
  { label: "Vermont", status: "live", note: "47 services indexed" },
  { label: "Wyoming", status: "live", note: "34 services indexed" },
  ...
  { label: "Alaska", status: "live", note: "34 services indexed" },
];
